      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-white relative">
        <div className="w-full max-w-[400px]">
          ...
          <div className="flex justify-between mt-6 text-sm">
            <a
              href="#"
              className="text-zinc-500 hover:text-zinc-800 underline transition-colors"
            >
              Forgot your password?
            </a>
            <Link
              href="/register"
              className="text-zinc-500 hover:text-zinc-800 underline transition-colors ml-auto"
            >
              Create an account
            </Link>
          </div>
